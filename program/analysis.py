...
if __name__ == "__main__":
    ...
    try:
        ...
        volume_open_positions_per_day = get_closed_df.groupby('created_date')['entryPrice'].sum().reset_index(name='volume_open_positions')

        # VOLUME CLOSED POSITIONS PER DAY
        volume_closed_positions_per_day = get_closed_df.groupby('closed_date')['exitPrice'].sum().reset_index(name='volume_closed_positions')

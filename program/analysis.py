...
for m in markets:
    ...
    trade_list.to_csv('dydxtradebot/program/output/trade_list.csv', header=True)
    pair_trades.to_csv('dydxtradebot/program/output/pair_trades.csv', header=True)
    total_per_day.to_csv('dydxtradebot/program/output/total_per_day.csv', header=True)
    balance.to_csv('dydxtradebot/program/output/balance.csv', header=True)
